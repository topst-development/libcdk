...
typedef union codec_specific_info_t
{
	...
	struct 
	{
		//!   AAC Stream Header type : ( 0: RAW-AAC, 1: ADTS, 2: ADIF, 3: LATM)
		TCAS_S32		m_iAACHeaderType;
		//!   AAC Stream Profile type : ( 0 : LC, 1 : HE, 2 : HE_PS, 3 : LD, 4 : ELD, 5 : LTP, 6 : SCALABLE)
		TCAS_S32		m_iAACProfileType;
		//!   bitrate mode : ( 0: CBR, 1: VBR_1, 2: VBR_2, 3: VBR_3, 4: VBR_4, 5: VBR_5 )
		TCAS_S32		m_iBitrateMode;
		//!	  RESERVED
...
typedef struct aenc_init_t
{
	...
	struct 
	{
		...
		TCAS_S32		m_iPcmLength;			//!< PCM data buffer size (samples * ch * sizeof(SINT16))
