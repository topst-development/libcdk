...
typedef struct adec_init_t
{
	...
	void* (*m_pfMemcpy		 ) ( void* dst, const void* src, size_t num);			//!< memcpy
	void  (*m_pfMemset		 ) ( void* ptr, int value, size_t num);					//!< memset
	void* (*m_pfRealloc		 ) ( void* ptr, size_t num);							//!< realloc
	void* (*m_pfMemmove		 ) ( void* dst, const void* src, size_t num);			//!< memmove
