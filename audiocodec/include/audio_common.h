...
typedef signed long 		TCAS_SLONG;
typedef unsigned long 		TCAS_ULONG;
...
typedef enum
{
	TCAS_SUCCESS									= (TCAS_S32)0,
	TCAS_ERROR_NULL_INSTANCE						= (TCAS_S32)-1,
	TCAS_ERROR_INVALID_OPINFO						= (TCAS_S32)-2,
	TCAS_ERROR_NOT_SUPPORT_FORMAT					= (TCAS_S32)-3,
	TCAS_ERROR_INVALID_BUFSTATE						= (TCAS_S32)-4,
	TCAS_ERROR_INVALID_DATA							= (TCAS_S32)-5,
	TCAS_ERROR_NULL_PCMBUFF							= (TCAS_S32)-6,
	TCAS_ERROR_DECODE								= (TCAS_S32)-7,
	TCAS_ERROR_ENCODE								= (TCAS_S32)-8,
	TCAS_ERROR_SEEK_FAIL							= (TCAS_S32)-9,
	TCAS_ERROR_INVALID_POS							= (TCAS_S32)-10,
	TCAS_ERROR_OPEN_FAIL							= (TCAS_S32)-11,
	TCAS_ERROR_CLOSE_FAIL							= (TCAS_S32)-12,
	TCAS_ERROR_MORE_DATA							= (TCAS_S32)-13,
	TCAS_ERROR_SKIP_FRAME							= (TCAS_S32)-14,
	TCAS_ERROR_CONCEALMENT_APPLIED					= (TCAS_S32)-15,
	//! Codec specified error code is defined here. 
	//! ex)1xx = 100, 121,...
	TCAS_ERROR_CODEC_SPECIFY						= (TCAS_S32)-100,
	TCAS_ERROR_DDP_NOT_SUPPORT_FRAME				= (TCAS_S32)-101,

	TCAS_ERROR_XX									= (TCAS_S32)0x7fffffff,
}TCAS_ERROR_TYPE;
